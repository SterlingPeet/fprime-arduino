...
function(run_arduino_wrapper)
    ...
    set(EXECUTE_ARGS "${PYTHON}" "${ARDUINO_WRAPPER_PATH}" ${ARGN} "-o" "${CMAKE_BINARY_DIR}/arduino-cli-core")
...
function(setup_arduino_libraries)
    ...
    run_arduino_wrapper("--generate-code" "-b" "${ARDUINO_FQBN}" "-g" "--libraries" ${ARDUINO_LIBRARY_LIST_LOCAL} "--copy" ${ARDUINO_EXTRA_FILES})
