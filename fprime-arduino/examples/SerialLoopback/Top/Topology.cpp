...
#include "SerialLoopbackSchedContexts.hpp"
...
static NATIVE_UINT_TYPE rg10HzContext[] = { SerialLoopback::CONTEXT_SERIALLOOPBACK_10Hz, 0, 0, 0};
Svc::ActiveRateGroupImpl rateGroup10HzComp("RG10Hz",rg10HzContext,FW_NUM_ARRAY_ELEMENTS(rg10HzContext));
// static NATIVE_UINT_TYPE rg1HzContext[] = {0, 0, SerialLoopback::CONTEXT_SERIALLOOPBACK_1Hz, 0};
...
example::LoopbackBlinkerComponent loopbackBlinker("loopbackBlinker");
Arduino::HardwareRateDriver hardwareRateDriver("RateDr", 100);
Drv::ATmegaGpioDriverComponentImpl ledGpio("ledGpio");
Drv::ATmegaSerialDriverComponentImpl comm("serialDriver");
...
void constructApp() {
    ...
    // SerialLoopbackTopologyAppAi.xml, and
    // incorporates the assembly name.
    constructSerialLoopbackArchitecture();

    // configure things
    comm.open(Drv::ATmegaSerialDriverComponentImpl::DEVICE::USART0,
