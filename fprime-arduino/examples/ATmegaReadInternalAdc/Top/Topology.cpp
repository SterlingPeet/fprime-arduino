...
#include "ATmegaReadInternalAdcSchedContexts.hpp"
...
static NATIVE_UINT_TYPE rg10HzContext[] = { ATmegaReadInternalAdc::CONTEXT_ATMEGAREADINTERNALADC_10Hz, 0, 0, 0};
Svc::ActiveRateGroupImpl rateGroup10HzComp("RG10Hz",rg10HzContext,FW_NUM_ARRAY_ELEMENTS(rg10HzContext));
// static NATIVE_UINT_TYPE rg1HzContext[] = {0, 0, ATmegaReadInternalAdc::CONTEXT_ATMEGAREADINTERNALADC_1Hz, 0};
...
Arduino::ReadingDisplayComponentImpl ReadingDisplay("ReadingDisplay");
Arduino::HardwareRateDriver hardwareRateDriver("RateDr", 100);
Drv::ATmegaInternalAdcDriverComponentImpl internalAdc("internalAdc");
...
void constructApp() {
    ...
    ReadingDisplay.init(0);

    internalAdc.init(0,7,0);
    ...
    // ATmegaReadInternalAdcTopologyAppAi.xml, and
    // incorporates the assembly name.
    constructATmegaReadInternalAdcArchitecture();
