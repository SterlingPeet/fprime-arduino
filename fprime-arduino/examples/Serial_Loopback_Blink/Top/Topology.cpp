...
#include <ATmega/examples/Serial_Loopback_Blink/Top/ArduinoSchedContexts.hpp>
#include <avr/io.h>
...
Arduino::LoopbackSerialComponentImpl loopbackSerialComp("Loopback");

// Baremetal setup for the task runner
Os::TaskRunner taskRunner;

Drv::ATmegaSerialDriverComponentImpl serialComp("UART0");
...
void constructApp() {
    ...
    serialComp.open(Drv::ATmegaSerialDriverComponentImpl::USART0, Drv::ATmegaSerialDriverComponentImpl::BAUD_9600);
