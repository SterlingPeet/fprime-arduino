...
#include <ATmega/examples/SPI_Loopback_Blink/Top/ArduinoSchedContexts.hpp>
...
Arduino::LoopbackComponentImpl loopbackComp("LB");
...
Drv::ATmegaSpiDriverComponentImpl spiComp("SPI");
...
// #endif
    ...
    spiComp.open(DDRB, PORTB, PB0);  // SS is PB0
